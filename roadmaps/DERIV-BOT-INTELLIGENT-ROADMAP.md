...
- [x] Sistema de backtesting visual (BacktestingVisual.tsx com equity curve e tabela de windows ✅)
- [x] Sistema de alertas frontend (AlertsConfig.tsx com Discord, Telegram, Email + endpoints REST ✅)
